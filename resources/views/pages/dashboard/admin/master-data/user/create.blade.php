...
@section('title', 'Tambah Data Pengguna - PeSarana')
@section('meta-description', 'Tambah data Pengguna PeSarana')
@section('meta-keywords', 'master data, tambah Pengguna, tambah user, Pengguna, user, PeSarana')
@section('content')
                    ...
                    <form action="{{ route('dashboard.admin.master-data.users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" name="email"
                                ...
                                id="floatingInputEmail" placeholder="Email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" name="password"
                                ...
                                id="floatingInputPassword" placeholder="Password" required>
