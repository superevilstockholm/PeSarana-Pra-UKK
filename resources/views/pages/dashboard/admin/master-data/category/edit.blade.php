...
@section('title', 'Ubah Data Kategori - PeSarana')
@section('meta-description', 'Ubah data kategori PeSarana')
@section('meta-keywords', 'master data, ubah kategori, edit category, kategori, category, PeSarana')
@section('content')
            ...
            <div class="card my-0">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.master-data.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi" id="floatingTextareaDescription" style="height: 120px">{{ old('description', $category->description) }}</textarea>
